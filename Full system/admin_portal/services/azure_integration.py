...
try:
    ...
    print("⚠️ Azure Storage SDK not available - install: pip install azure-storage-blob")
...
try:
    ...
    print("⚠️ Azure Identity SDK not available - install: pip install azure-identity")
...
try:
    ...
    print("⚠️ Azure Key Vault SDK not available - install: pip install azure-keyvault-secrets")
...
try:
    ...
    print("⚠️ Azure Cognitive Services SDK not available - install: pip install azure-cognitiveservices-textanalytics")
...
try:
    ...
    print("⚠️ Azure OpenAI SDK not available - install: pip install azure-ai-openai")
...
class AzureConfigurationManager:
    ...
    def save_configuration(self):
        ...
        try:
            ...
            print("✅ Azure configuration saved")
        except Exception as e:
            print(f"❌ Error saving Azure config: {e}")
    ...
    def get_credential(self):
        ...
        try:
            ...
            print(f"❌ Error creating Azure credential: {e}")
            return None
