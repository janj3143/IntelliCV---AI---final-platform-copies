...
def show_main_dashboard():
    ...
    <div class="dashboard-container">
        <div style='background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
            ...
            <p style="font-size: 1.1em; opacity: 1; margin-top: 1rem;"><strong>📄 {page_count} Admin Pages Available</strong></p>
            <p style="font-size: 0.9em; opacity: 0.9;">Best-of-Breed v1.0 - October 11, 2025</p>
        </div>
    </div>
    """, unsafe_allow_html=True)
    
    # Portal role clarification
    st.info("""
    ℹ️ **Portal Information:**  
    This is the **ADMIN PORTAL** for system configuration, user management, and backend operations.  
    Users access the platform through the **USER PORTAL** (separate entry point with {0} user-facing pages).
    """.format(25))
