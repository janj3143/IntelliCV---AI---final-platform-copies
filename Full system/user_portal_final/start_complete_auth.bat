...
if exist "env310\Scripts\python.exe" (
    ...
    env310\Scripts\python.exe -m streamlit run "SANDBOX\user_portal_final\enhanced_app_complete_auth.py" --server.port 8506
) else if exist "python.exe" (
    echo Using local Python executable...
    python.exe -m streamlit run "SANDBOX\user_portal_final\enhanced_app_complete_auth.py" --server.port 8506
) else (
    echo Trying system Python...
    python -m streamlit run "SANDBOX\user_portal_final\enhanced_app_complete_auth.py" --server.port 8506
)
