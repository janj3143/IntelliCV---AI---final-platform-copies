...
with col1:
    ...
    # Upload zone styling with note about drag-drop
    if not uploaded_file and not has_existing_resume:
        st.markdown('''
        <div class="upload-zone">
            <h3>📁 Click "Browse files" to Upload Your Resume</h3>
            <p><strong>Note:</strong> Please use the "Browse files" button above to select your file</p>
            <p style="color: #666; font-size: 0.9rem;">PDF, DOCX, or TXT files supported (max 10MB)</p>
            <p style="color: #f39c12; font-size: 0.85rem; margin-top: 0.5rem;">
                💡 <em>Drag & drop is not currently supported - use the browse button instead</em>
            </p>
        </div>
        ''', unsafe_allow_html=True)
