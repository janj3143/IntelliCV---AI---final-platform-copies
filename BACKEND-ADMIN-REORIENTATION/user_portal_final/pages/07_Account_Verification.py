...
# Developer/Debug Section (only show in development)
if st.session_state.get("dev_mode", False) or st.checkbox("🧪 Show Developer Tools"):
    st.markdown("### 🛠️ Developer/Admin Tools")
