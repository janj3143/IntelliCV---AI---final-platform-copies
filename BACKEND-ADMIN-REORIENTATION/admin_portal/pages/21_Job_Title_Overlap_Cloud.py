...
class JobTitleOverlapEngine:
    ...
    def _load_job_titles_database(self) -> Dict:
        """Load the enhanced job titles database"""
        try:
        ...
        return {
            "categorized_titles": {
                ...
                "Business": [
                    ...
                    "Operations Manager", "Strategy Consultant", "Account Manager", "Product Owner"
                ],
                "Finance": [
                    "Financial Analyst", "Investment Banker", "Risk Manager", "Accountant",
                    "Treasury Analyst", "Credit Analyst", "Portfolio Manager", "Financial Planner"
                ],
                "Healthcare": [
                    "Registered Nurse", "Physical Therapist", "Medical Assistant", "Healthcare Administrator",
                    "Clinical Research Coordinator", "Healthcare Data Analyst", "Medical Device Engineer"
                ]
            },
            "skill_mappings": self._get_default_skill_mappings()
        }
    ...
    def _load_skill_mappings(self) -> Dict[str, List[str]]:
        """Load skill mappings for job titles"""
        return self._get_default_skill_mappings()
    
    def _get_default_skill_mappings(self) -> Dict[str, List[str]]:
        """Default skill mappings"""
        return {
            "Software Engineer": ["Programming", "Problem Solving", "Testing", "Code Review", "System Design"],
            "Data Scientist": ["Python", "Machine Learning", "Statistics", "Data Analysis", "Visualization"],
            "Product Manager": ["Strategy", "User Research", "Analytics", "Communication", "Roadmapping"],
            "UX Designer": ["Design Thinking", "User Research", "Prototyping", "Visual Design", "Usability"],
            "Marketing Manager": ["Digital Marketing", "Analytics", "Brand Management", "Campaign Management"],
            "Financial Analyst": ["Financial Modeling", "Excel", "Forecasting", "Risk Assessment", "Reporting"],
            "Project Manager": ["Project Planning", "Team Leadership", "Risk Management", "Communication"],
            "Business Analyst": ["Requirements Analysis", "Process Mapping", "Stakeholder Management", "Documentation"]
        }
