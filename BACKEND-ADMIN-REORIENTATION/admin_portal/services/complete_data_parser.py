...
class CompleteDataParser(LoggingMixin, SafeOperationsMixin):
    ...
    def _discover_data_directories(self) -> List[Path]:
        ...
        potential_directories = [
            ...
            Path("C:/IntelliCV/data"),  # Absolute fallback
        ]
    ...
    def process_all_data(self, include_historical: bool = True) -> Dict[str, Any]:
        ...
        self.safe_write_json(processing_results, results_file)
    ...
    def _extract_candidate_from_document(self, file_path: Path) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            candidate = {
                ...
                "extraction_method": "complete_data_parser"
            }
...
def main():
    ...
    # Initialize parser
    complete_parser = CompleteDataParser(base_path=args.base_path)
