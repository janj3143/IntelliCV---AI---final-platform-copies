...
def get_default_ai_data_path() -> Path:
    """Get the default AI data path for the SANDBOX environment"""
    # Always point to SANDBOX/ai_data_final
    return Path("c:/IntelliCV-AI/IntelliCV/SANDBOX/ai_data_final")
...
def browse_ai_data_path() -> Optional[Path]:
    ...
    manual_path = st.text_input(
        ...
        placeholder="c:/IntelliCV-AI/IntelliCV/SANDBOX/ai_data_final",
